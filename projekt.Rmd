...
**Priseljevanje:** Kot je pričakovati so najbolj na udaru starostne skupine: **25-29 let** ter **30-34 let**. To so najbolj izobražene starostne skupine, ki zaposlitev iščejo izven Slovenije, saj je tu ne dobijo ali pa so priložnosti ter tudi plača mnogo boljše v tujini.

**Odseljevanje:** Tudi tu so starstne skupine, ki so najbolj izpostavljene enake kot pri priseljevanju. To so najbolj izobražene starostne skupine, ki zaposlitev iščejo izven Slovenije, saj je tu ne dobijo ali pa so priložnosti ter tudi plača mnogo boljše v tujini.
...
**Odseljevanje:** Očitno je odseljevanje najmočnejše v osrednjeslovenski regiji skozi vsa leta. Regiji ki izstopata sta še podravska in savinjska 1995 pa je odseljevanje v podravski regiji posledica osamosvojitve Slovenije, ko je v Mariboru propadla velika večina podjetij. Odseljevanje iz podravske regije skokoma naraste še leta 2008 in celo preseže odseljevanje iz osrednjeslovenske regije.
...
shinyAppDir("shiny6", options=list(width="100%", height=440))
```
...
shinyAppDir("shiny7", options=list(width="100%", height=440))
```
...
Napovedovanje preseljevanja je težko oziroma skoraj nemogoče, saj se ne da napovedati dogodkov, ki sprožijo ta proces. Razlogi za preseljevanje so lahko osebni (iskanje boljše zaposlitve, ambicije, kariera,..), taki in drugačni pritiski na ljudi na določenem območju, iskanje azila, beg pred skrajneži,... Vseeno pa vidimo da sledi nekim vzorcem pogojenimi z spolom, starostjo,...