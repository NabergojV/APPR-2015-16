...
_Graf lahko prilagodimo svojim željam glede smeri preseljevanja, državljanstva, starostne skupine ter spola. Pri določenih skupinah se lahko prihodnje preseljevanje napove z večjo gotovostjo kot drugje. Nekaj takih skupin je izpostavljenih pod grafom._
...
shinyAppDir("shiny6", options=list(width="100%", height=505))
```
