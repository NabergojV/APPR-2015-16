...
#####Funkcij za filtriranje podatkov iz tabel
```{r funkcija razberi}
...
Tudi tu sem morala najprej prečistiti podatke, izbrisati določene vrstice in nato s funkcijo uredimo pretvorila v želene tabele. 
